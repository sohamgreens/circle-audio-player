...
d(this).data("radius")?d(this).data("radius"):100,b=d(this).data("skin")?d(this).data("skin"):"default",a=new g(d(this)[0],{radius:a,skin:b});d(this).data("circle-audio-player",a)})};d(function(){d("[data-circle-audio-player]").circleAudioPlayer()})})(jQuery);CircleAudioPlayerSkins=CircleAudioPlayerSkins||{};
...
margin:35,shadow:{type:"outer"}},buttons:{playColor:"#005400",playHoverColor:"#44ce44",pauseColor:"#005400",pauseHoverColor:"#44ce44",soundLed:{color:"#00ff00",size:1}}}});
